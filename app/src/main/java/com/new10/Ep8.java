...
public class Ep8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q8 - Use suitable Prepositions to fill in the blank : \n The principal is _____ the hall.";
		tv1.setText(s);
		rb1.setText("in");
		rb2.setText("to");
		rb3.setText("at");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep9.class);
