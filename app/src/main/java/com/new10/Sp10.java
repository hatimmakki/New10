...
public class Sp10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sp10);
		...
		String s="Q10 - No matter far you stand from a mirror, your image appears erect. The mirror is likely to be";
		tv1.setText(s);
		rb1.setText("plane or convex");
		rb2.setText("convex mirror");
		rb3.setText("concave mirror");
		rb4.setText("plane mirror");
