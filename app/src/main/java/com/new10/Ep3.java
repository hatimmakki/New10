...
public class Ep3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q3 - Use suitable Prepositions to fill in the blank : \n The sun gives light _____ the day.";
		tv1.setText(s);
		rb1.setText("at");
		rb2.setText("on");
		rb3.setText("in");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep4.class);
