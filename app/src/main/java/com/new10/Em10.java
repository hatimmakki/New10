...
public class Em10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q10 - Use Suitable Modals to fill the blanks : \n It's almost time for my train . I ____ leave now.";
		tv1.setText(s);
		rb1.setText("must");
		rb2.setText("may");
		rb3.setText("can");
		rb4.setText("ought to");
