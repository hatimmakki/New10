...
public class Sp9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sp9);
		...
		String s="Q9 - The least distance of distinct vision for a young adult with normal vision is about _____ .";
		tv1.setText(s);
		rb1.setText("2.5cm");
		rb2.setText("25cm");
		rb3.setText("25m");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp10.class);
