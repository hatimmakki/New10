...
public class Ma9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ma9);
		...
		String s="Q9 - Find the value of k , such that the equation kx(x-2)+6=0 have equal roots.";
		tv1.setText(s);
		rb1.setText("6");
		rb2.setText("4");
		rb3.setText("2");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ma10.class);
