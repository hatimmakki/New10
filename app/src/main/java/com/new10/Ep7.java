...
public class Ep7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q7 - Use suitable Prepositions to fill in the blank : \n The work must be finished ___ monday.";
		tv1.setText(s);
		rb1.setText("from");
		rb2.setText("at");
		rb3.setText("within");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep8.class);
