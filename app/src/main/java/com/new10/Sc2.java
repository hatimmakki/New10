...
public class Sc2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q2 - The removal of oxygen and addition of hydrogen is called ______ reaction. ";
		tv1.setText(s);
		rb1.setText("redox");
		rb2.setText("reduction");
		rb3.setText("oxidation");
		rb4.setText("precipitation");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sc3.class);
