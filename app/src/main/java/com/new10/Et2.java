...
public class Et2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q2 - Use present Perfect Continuous to fill : \n He has been  ____(live) in Delhi ____  1991.";
		tv1.setText(s);
		rb1.setText("lived , since");
		rb2.setText("living , since");
		rb3.setText("lived , for");
		rb4.setText("living , for");
