...
public class Sc9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q9 - Mendeleev's periodic table is based on ______";
		tv1.setText(s);
		rb1.setText("atomic number");
		rb2.setText("atomic mass");
		rb3.setText("atomic size");
		rb4.setText("combining capacity");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sc10.class);
