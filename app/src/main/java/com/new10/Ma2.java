...
public class Ma2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q2 - The pair of lines 5x-4y+8=0 and 7x+6y-9=0 are : ";
		tv1.setText(s);
		rb1.setText("Parallel");
		rb2.setText("will intersect at a point");
		rb3.setText("coincident");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ma3.class);
