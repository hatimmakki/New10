...
public class Ep5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q5 - Use suitable Prepositions to fill in the blank : \n The book is _____ table.";
		tv1.setText(s);
		rb1.setText("in");
		rb2.setText("on");
		rb3.setText("by");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep6.class);
