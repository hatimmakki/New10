...
public class Sp6 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q6 - Which of the following does not represent electrical power in a circuit ?";
		tv1.setText(s);
		rb1.setText("VI");
		rb2.setText("sq(I)*R");
		rb3.setText("sq(R)*I");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp7.class);
