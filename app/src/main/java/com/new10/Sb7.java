...
public class Sb7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q7 - Which of the following is a plant harmone ?";
		tv1.setText(s);
		rb1.setText("insulin");
		rb2.setText("thyroxin");
		rb3.setText("oxytocin");
		rb4.setText("auxin");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb8.class);
