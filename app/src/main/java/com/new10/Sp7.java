...
public class Sp7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sp7);
		...
		String s="Q7 - The device used for producing electric current is called a .";
		tv1.setText(s);
		rb1.setText("generator");
		rb2.setText("ammeter");
		rb3.setText("galvanometer");
		rb4.setText("none");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp8.class);
