...
public class Sc4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q4 - Which one of the following types of medicines is used for treating indigestion ?";
		tv1.setText(s);
		rb1.setText("Antibiotic");
		rb2.setText("Antacid");
		rb3.setText("Analgesic");
		rb4.setText("Antiseptic");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sc5.class);
