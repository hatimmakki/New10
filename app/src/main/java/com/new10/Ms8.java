...
public class Ms8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ms8);
		...
		String s="Q8 - If P(E)=0.05, What is the probability of 'not E' ";
		tv1.setText(s);
		rb1.setText("0.95");
		rb2.setText("1.05");
		rb3.setText("1");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ms9.class);
