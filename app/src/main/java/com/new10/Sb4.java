...
public class Sb4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q4 - The gap between two neurons is called ";
		tv1.setText(s);
		rb1.setText("dendrite");
		rb2.setText("synapse");
		rb3.setText("axon");
		rb4.setText("impulse");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb5.class);
