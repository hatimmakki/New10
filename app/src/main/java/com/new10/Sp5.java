...
public class Sp5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sp5);
		...
		String s="Q5 - An electric bulb is rated 220V and 100W. When it is operated on 110V, the power " +
				"consumed will be -.";
		tv1.setText(s);
		rb1.setText("50W");
		rb2.setText("75W");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp6.class);
