...
public class Em9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_em9);
		...
		String s="Q1 - Use suitable Modals to fill blank : \n The rich ____ help the poor.";
		tv1.setText(s);
		rb1.setText("need to");
		rb2.setText("shall");
		rb3.setText("ought to");
		rb4.setText("used to");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Em10.class);
