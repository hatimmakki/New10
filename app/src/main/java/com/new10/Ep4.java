...
public class Ep4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q4 - Use suitable Prepositions to fill in the blank : \n Children get presents _____ christmas and _____ their birthday.";
		tv1.setText(s);
		rb1.setText("at , at");
		rb2.setText("on , at");
		rb3.setText("at , on");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep5.class);
