...
public class Sb3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q3 - The autotrophic mode of nutrition requires ";
		tv1.setText(s);
		rb1.setText("CO2 , water");
		rb2.setText("Chlorophyll");
		rb3.setText("Sunlight");
		rb4.setText("All of above");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb4.class);
