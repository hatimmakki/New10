...
public class Em4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_em4);
		...
		String s="Q4 - Use suitable Modals to fill : \n What cannot cured _____ be endured.";
		tv1.setText(s);
		rb1.setText("must");
		rb2.setText("used to");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Em5.class);
