...
public class Sp3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q3 - Which one of the following materials cannot be used to make a lens ?";
		tv1.setText(s);
		rb1.setText(" water");
		rb2.setText("glass");
		rb3.setText("plastic");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp4.class);
