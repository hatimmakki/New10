...
public class Sb1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q1 - The kidneys in human beings are a part of the system for ";
		tv1.setText(s);
		rb1.setText("Nutrition");
		rb2.setText("Respiration");
		rb3.setText("Excretion");
		rb4.setText("Transportation");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb2.class);
