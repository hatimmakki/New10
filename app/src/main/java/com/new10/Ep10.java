...
public class Ep10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ep10);
		...
		String s="Q10 - Use suitable Prepositions to fill in the blank : \n I baught a newspaper ____ my way ____ bus stand.";
		tv1.setText(s);
		rb1.setText("in , at");
		rb2.setText("on , to");
		rb3.setText("at , in");
