...
public class Sb2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q2 - The xylem in plants are responsible for transportation of _______ .";
		tv1.setText(s);
		rb1.setText("gases");
		rb2.setText("water");
		rb3.setText("food");
		rb4.setText("amino acid");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb3.class);
