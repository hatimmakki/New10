...
public class Sb10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q10 - Which molecule is formed during respiration when limited oxygen is present ?";
		tv1.setText(s);
		rb1.setText("Lactic acid");
		rb2.setText("Ethanol");
		rb3.setText("Pyruvate");
		rb4.setText("ATP");
