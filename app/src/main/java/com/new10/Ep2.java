...
public class Ep2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q2 - Use suitable Prepositions to fill in the blank : \n Do you like to live ____ a bunglow.";
		tv1.setText(s);
		rb1.setText("at");
		rb2.setText("on");
		rb3.setText("in");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ep3.class);
