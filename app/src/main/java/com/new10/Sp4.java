...
public class Sp4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q4 - The change in focal length of an eye lens is caused by the action of the -";
		tv1.setText(s);
		rb1.setText("ciliary muscels");
		rb2.setText("pupil");
		rb3.setText("retina");
		rb4.setText("iris");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sp5.class);
