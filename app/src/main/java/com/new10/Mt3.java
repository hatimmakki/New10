...
public class Mt3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q3 - In triangle ABC, right angled at B. If TanA=1 ,find the value of -> SinA*CosC + SinC * CosA  : ";
		tv1.setText(s);
		rb1.setText("4");
		rb2.setText("3");
		rb3.setText("2");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Mt4.class);
