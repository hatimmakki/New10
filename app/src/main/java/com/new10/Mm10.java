...
public class Mm10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q10 - A glass is in shape of a frustum of a cone having height 14 cm. The diameters of its" +
				"circular ends are 2cm and 4cm. Find the capacity of the glass ";
		tv1.setText(s);
		rb1.setText("307/3 cube m");
		rb2.setText("308/3 cube m");
		rb3.setText("307.3 cube m");
		rb4.setText("308.3 cube m");
