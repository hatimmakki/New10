...
public class Mm9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q9 - Water in a canal 6m wide and 1.5m wide is flowing with a velocity of 10km/h. How much" +
				"area will it irrigate in 30 minutes, If 8cm of standing water is needed.";
		tv1.setText(s);
		rb1.setText("562500 sq.m");
		rb2.setText("5625 sq.m");
		rb3.setText("56250 sq.m");
		rb4.setText("652500 sq.m");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Mm10.class);
