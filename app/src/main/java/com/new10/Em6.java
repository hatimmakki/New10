...
public class Em6 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_em6);
		...
		String s="Q6 - Fill in the blank with suitable modals : \n With some luck we _____ win the match.";
		tv1.setText(s);
		rb1.setText("may");
		rb2.setText("might");
		rb3.setText("can");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Em7.class);
