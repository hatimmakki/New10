...
public class Ms4 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ms4);
		...
		String s="Q4 - Find the values of y for which the distance between the points A(2,-3) and B(10,y)" +
				" is 10 units ";
		tv1.setText(s);
		rb1.setText("3,-9");
		rb2.setText("-9,3");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ms5.class);
