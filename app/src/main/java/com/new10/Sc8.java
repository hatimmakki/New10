...
public class Sc8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_sc8);
		...
		String s="Q8 - Butanone is 4-Carbon compound with functional group";
		tv1.setText(s);
		rb1.setText("aldehyde");
		rb2.setText("alcohol");
		rb3.setText("ketone");
		rb4.setText("carboxylic acid");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sc9.class);
