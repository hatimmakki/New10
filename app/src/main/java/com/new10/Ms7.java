...
public class Ms7 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ms7);
		...
		String s="Q7 - Which of the following cannot be the probability of an event.";
		tv1.setText(s);
		rb1.setText("2/3");
		rb2.setText("-1.5");
		rb3.setText("15%");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Ms8.class);
