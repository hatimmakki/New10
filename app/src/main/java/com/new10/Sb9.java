...
public class Sb9 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q9 - 'Survival of the fittest' is the theory given by -";
		tv1.setText(s);
		rb1.setText("Mendel");
		rb2.setText("Darwin");
		rb3.setText("Thomsan");
		rb4.setText("Rutherford");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb10.class);
