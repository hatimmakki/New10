...
public class Sb6 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q6 - Asexual reproduction through budding takes place through budding in ";
		tv1.setText(s);
		rb1.setText("hydra");
		rb2.setText("amoeba");
		rb3.setText("yeast");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Sb7.class);
