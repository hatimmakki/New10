...
public class Ms10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ms10);
		...
		String s="Q10 - A die is throwen two times.What is the probability that 5 will come up atleast once.";
		tv1.setText(s);
		rb1.setText("11/36");
		rb2.setText("1/5");
		rb3.setText("1/6");
