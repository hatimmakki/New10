...
public class Mt5 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q5 - If Tan2A = Cot(A-18), where 2A is an acute angle, then value of A in degrees is: ";
		tv1.setText(s);
		rb1.setText("0");
		rb2.setText("45");
		rb3.setText("36");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Mt6.class);
