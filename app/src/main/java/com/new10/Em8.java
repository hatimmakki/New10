...
public class Em8 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_em8);
		...
		String s="Q8 - Use suitable modals to fill : \n People ____  think that the earth was flat.";
		tv1.setText(s);
		rb1.setText("ought to");
		rb2.setText("used to");
		rb3.setText("can");
		rb4.setText("would");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Em9.class);
