...
public class Et10 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_et10);
		...
		String s="Q10 - Use Future Simple tense to fill : \n If you run fast, you ____ (catch) the train.";
		tv1.setText(s);
		rb1.setText("shall catch");
		rb2.setText("will caught");
		rb3.setText("will catch");
		rb4.setText("shall catch");
