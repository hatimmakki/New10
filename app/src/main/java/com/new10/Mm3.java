...
public class Mm3 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String s="Q3 - The length of minute hand of a clock is equal to 14cm.find out area swept by minute" +
				"hand in 5 minutes.";
		tv1.setText(s);
		rb1.setText("45 sq.cm");
		rb2.setText("154/3 sq.cm");
		rb3.setText("151/3 sq.cm");
		rb4.setText("54.3 sq.cm");
		...
		next.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i=new Intent(getApplicationContext(), Mm4.class);
